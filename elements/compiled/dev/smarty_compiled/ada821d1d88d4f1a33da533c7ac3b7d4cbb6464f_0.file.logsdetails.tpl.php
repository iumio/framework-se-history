...
?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['details']->value->code_title;?>
                                ...
                                <hr>
                                <p class="category fs16"><i class="pe-7s-clock"></i> Date : <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['details']->value->time->date,"%A, %B %e, %Y at %r");?>
</p>
                                <hr>
                                ...
                                <hr>
                                <?php if ($_smarty_tpl->tpl_vars['details']->value->type_error != null) {?> { <?php echo '?>';?><p class="category fs16"><i class="pe-7s-close-circle"></i> Type : <?php echo $_smarty_tpl->tpl_vars['details']->value->type_error;?>
</p><hr/><?php }?>
                            </div>
                            <div class="content text-center">
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content" style="padding-top: 0px">
                                ...
                                <hr>
                                <?php if ($_smarty_tpl->tpl_vars['details']->value->file_error != null) {?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['details']->value->line_error != null) {?>
