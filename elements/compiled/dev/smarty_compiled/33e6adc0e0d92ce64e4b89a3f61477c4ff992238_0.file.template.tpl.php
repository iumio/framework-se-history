...
function content_59ce46cba57309_37393485 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_26258627859ce46c893ae52_29834600', "subtitle");
?>
</title>
...
#fh5co-pricing" data-nav-section="design">Download</a></li>
        <li class=""><a href="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::route(array('name'=>"website_contact"),$_smarty_tpl);?>
...
<div id="fh5co-page">
    <div id="fh5co-wrap">
        <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_134537127159ce46caaf42e2_03828899', "content");
?>
...
<?php }
/* {block "subtitle"} */
class Block_26258627859ce46c893ae52_29834600 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'subtitle' => 
  array (
    0 => 'Block_26258627859ce46c893ae52_29834600',
  ),
);
...
/* {/block "subtitle"} */
/* {block "content"} */
class Block_134537127159ce46caaf42e2_03828899 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_134537127159ce46caaf42e2_03828899',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12">
                                <a href="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"danyrafina")),$_smarty_tpl);?>
" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::webassets(array('path'=>'public/images/dany.jpg'),$_smarty_tpl);?>
" alt="DANY RAFINA" class="img-responsive">
                                    ...
                                    <p class="fh5co-figure-text download" onclick="location.href='<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"danyrafina")),$_smarty_tpl);?>
'">Click on it for more details
                                    </p>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"kevinhuron")),$_smarty_tpl);?>
" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::webassets(array('path'=>'public/images/kevin.jpg'),$_smarty_tpl);?>
" alt="KEVIN HURON" class="img-responsive text-center center-block">
                                    ...
                                    <p class="fh5co-figure-text download" onclick="location.href='<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"kevinhuron")),$_smarty_tpl);?>
'">Click on it for more details
                                    </p>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="#" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::webassets(array('path'=>'public/images/user.jpg'),$_smarty_tpl);?>
" alt="MAYBE YOU ?" class="img-responsive text-center center-block">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="#" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\ViewBasePlugin::webassets(array('path'=>'public/images/user_2.jpg'),$_smarty_tpl);?>
" alt="MAYBE YOU" class="img-responsive text-center center-block">
                                    </figure>
                                    <h3 class="fh5co-figure-lead">Maybe you ?</h3>
                                    <p class="fh5co-figure-text">What you can do ? <br> &nbsp; <br> &nbsp;</p>
