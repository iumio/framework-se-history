...
function content_59c9652343ee48_94358253 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_36163562659c965207dbde8_95370364', "subtitle");
?>
</title>
  ...
  //////////////////////////////////////////////////////
   -->
    ...
    <!-- Animate.css -->
   <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/animate'),$_smarty_tpl);?>

    <!-- Icomoon Icon Fonts-->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/icomoon'),$_smarty_tpl);?>

    <!-- Simple Line Icons-->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/simple-line-icons'),$_smarty_tpl);?>

    <!-- Magnific Popup -->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/magnific-popup'),$_smarty_tpl);?>

    <!-- Owl Carousel -->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/owl.carousel.min'),$_smarty_tpl);?>

    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/owl.theme.default.min'),$_smarty_tpl);?>

    <!-- Theme Style -->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::css(array('path'=>'public/css/style'),$_smarty_tpl);?>

    <!-- Modernizr JS -->
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/modernizr-2.6.2.min'),$_smarty_tpl);?>

    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/respond-2.6.2.min'),$_smarty_tpl);?>
...
<div id="fh5co-offcanvass">
    <ul>
        ...
        <li class=""><a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_index"),$_smarty_tpl);?>
#fh5co-faqs" data-nav-section="features">FAQ</a></li>
        <li><a href="/">Documentation</a></li>
        <li><a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_index"),$_smarty_tpl);?>
...
#fh5co-pricing" data-nav-section="design">Download</a></li>
        <li class=""><a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_contact"),$_smarty_tpl);?>
" data-nav-section="testimonies">Contact</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/iumio.logo.black.png'),$_smarty_tpl);?>
" class="img-responsive" style="padding-top: 13px;" width="150" onclick="location.href='<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_index"),$_smarty_tpl);?>
'">
            </div>
        </div>
    </div>
...
<div id="fh5co-page">
    <div id="fh5co-wrap">
        <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_186856377759c9652259ff06_03745914', "content");
?>
...
#fh5co-features">Features</a></li>
                            <li><a href="https://iumio.com">iumio Components</a></li>
                            <li><a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_contact"),$_smarty_tpl);?>
">Contact</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-4 col-md-push-3">
                    ...
                    <div class="col-md-3 col-sm-12 col-md-pull-9">
                        <div class="fh5co-footer-logo"><img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/iumio.logo.black.png'),$_smarty_tpl);?>
...
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::jquery(array('min'=>'yes'),$_smarty_tpl);?>

<!-- jQuery Easing -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/jquery.easing.1.3'),$_smarty_tpl);?>

<!-- Bootstrap -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::btsp_js(array('min'=>'yes'),$_smarty_tpl);?>

<!-- Waypoints -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/jquery.waypoints.min'),$_smarty_tpl);?>

<!-- Magnific Popup -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/jquery.magnific-popup.min'),$_smarty_tpl);?>

<!-- Owl Carousel -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/owl.carousel.min'),$_smarty_tpl);?>

<!-- toCount -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/jquery.countTo'),$_smarty_tpl);?>

<!-- Main JS -->
<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::js(array('path'=>'public/js/main'),$_smarty_tpl);?>
...
<?php }
/* {block "subtitle"} */
class Block_36163562659c965207dbde8_95370364 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'subtitle' => 
  array (
    0 => 'Block_36163562659c965207dbde8_95370364',
  ),
);
...
/* {/block "subtitle"} */
/* {block "content"} */
class Block_186856377759c9652259ff06_03745914 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_186856377759c9652259ff06_03745914',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-pull-4 fh5co-image animate-object features-2-animate-2">
                                <p class="text-center">
                                    <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/iphone_blank_2.png'),$_smarty_tpl);?>
                        ...
                        <div class="owl-carousel">
                            ...
                            <div class="item">
                                <div class="col-md-3 col-sm-3 col-xs-4 col-xxs-12">
                                    <figure class="fh5co-vcard"><img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/user.jpg'),$_smarty_tpl);?>
" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive"></figure>
                            ...
                            <div class="item">
                                <div class="col-md-3 col-sm-3 col-xs-4 col-xxs-12">
                                    <figure class="fh5co-vcard"><img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/user_2.jpg'),$_smarty_tpl);?>
" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive"></figure>
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                                    <blockquote>
                            ...
                            <div class="item">
                                <div class="col-md-3 col-sm-3 col-xs-4 col-xxs-12">
                                    <figure class="fh5co-vcard"><img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/user_3.jpg'),$_smarty_tpl);?>
" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive"></figure>
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-8 col-xxs-12">
                                    <blockquote>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12">
                                <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"danyrafina")),$_smarty_tpl);?>
" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/dany.jpg'),$_smarty_tpl);?>
" alt="DANY RAFINA" class="img-responsive">
                                    </figure>
                                    <h3 class="fh5co-figure-lead">Dany RAFINA</h3>
                                    <p class="fh5co-figure-text">iumio Architect <br> Founder of iumio Components &nbsp; &nbsp;</p>
                                    <p class="fh5co-figure-text download" onclick="location.href='<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"danyrafina")),$_smarty_tpl);?>
'">Click on it for more details
                                    </p>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"kevinhuron")),$_smarty_tpl);?>
" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/kevin.jpg'),$_smarty_tpl);?>
" alt="KEVIN HURON" class="img-responsive text-center center-block">
                                    </figure>
                                    <h3 class="fh5co-figure-lead">Kevin Huron</h3>
                                    <p class="fh5co-figure-text">iumio Co-Architect <br> Co-Founder of iumio Components
                                    </p>
                                    <p class="fh5co-figure-text download" onclick="location.href='<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_user_contributor",'params'=>array("fullname"=>"kevinhuron")),$_smarty_tpl);?>
'">Click on it for more details
                                    </p>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="#" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/user.jpg'),$_smarty_tpl);?>
" alt="MAYBE YOU ?" class="img-responsive text-center center-block">
                                    </figure>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
                                <a href="#" class="fh5co-figure to-animate ">
                                    <figure>
                                        <img src="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::webassets(array('path'=>'public/images/user_2.jpg'),$_smarty_tpl);?>
" alt="MAYBE YOU" class="img-responsive text-center center-block">
                                    </figure>
                                    <h3 class="fh5co-figure-lead">Maybe you ?</h3>
                                    <p class="fh5co-figure-text">What you can do ? <br> &nbsp; <br> &nbsp;</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 to-animate">
                            <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_download",'params'=>array("edition"=>"SE")),$_smarty_tpl);?>
" class="fh5co-figure active pricing-feature">
                        ...
                        <div class="col-md-3 to-animate">
                            <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_download",'params'=>array("edition"=>"PE")),$_smarty_tpl);?>
" class="fh5co-figure">
                        ...
                        <div class="col-md-3 to-animate">
                            <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_download",'params'=>array("edition"=>"SU")),$_smarty_tpl);?>
" class="fh5co-figure">
                        ...
                        <div class="col-md-3 to-animate">
                            <a href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>"website_download",'params'=>array("edition"=>"API")),$_smarty_tpl);?>
" class="fh5co-figure">
