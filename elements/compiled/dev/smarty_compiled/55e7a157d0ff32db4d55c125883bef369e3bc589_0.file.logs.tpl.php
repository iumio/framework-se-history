<?php
/* Smarty version 3.1.31, created on 2017-09-28 09:38:41
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59cca7016e05c8_12671035',
...
function content_59cca7016e05c8_12671035 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_128911243259cca700f3a4e7_15563940', "principal");
$_smarty_tpl->inheritance->endChild($_smarty_tpl, 'template.tpl');
}
/* {block "principal"} */
class Block_128911243259cca700f3a4e7_15563940 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'principal' => 
  array (
    0 => 'Block_128911243259cca700f3a4e7_15563940',
  ),
);
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="btn-default btn clearlogs"  attr-href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>'iumio_manager_logs_manager_clear','params'=>array('env'=>"dev")),$_smarty_tpl);?>
" attr-env="dev">Clear logs - dev</a>
                    <a class="btn-default btn clearlogs"  attr-href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>'iumio_manager_logs_manager_clear','params'=>array('env'=>"prod")),$_smarty_tpl);?>
...
">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="content dashboardStats2" attr-href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>'iumio_manager_dashboard_get_statistics'),$_smarty_tpl);?>
">
                                <ul>
                                    <li class="iumiohidden">Apps  : <span class="dashb-app">0</span> </li>
                                    <li class="iumiohidden">Apps enabled : <span class="dashb-appena">0</span></li>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width iumio-unlimited-log-display">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody class="logslist" attr-href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>'iumio_manager_logs_manager_get_all','params'=>array('env'=>"dev")),$_smarty_tpl);?>
">
                                    <!--<tr>
                                        <td>0</td>
                                        <td>DakotaRice</td>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width iumio-unlimited-log-display2">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody class="logslist2" attr-href="<?php echo iumioFramework\Core\Additionnal\Template\iumioViewBasePlugin::route(array('name'=>'iumio_manager_logs_manager_get_all','params'=>array('env'=>"prod")),$_smarty_tpl);?>
">
                                    <!--<tr>
                                        <td>0</td>
                                        <td>DakotaRice</td>
