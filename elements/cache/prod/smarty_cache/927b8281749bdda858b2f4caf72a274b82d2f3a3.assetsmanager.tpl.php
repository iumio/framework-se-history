<?php
/* Smarty version 3.1.31, created on 2017-08-28 08:34:35
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59a3b97b816529_84423682',
...
function content_59a3b97b816529_84423682 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
<head>
                            ...
                            <div class="card">
                                ...
                                <div class="content">
                                    <div class="row center-block text-center manager-options">
                                        <div class="col-md-4">
                                            <a class="btn-default btn publishallassets"  attr-href="/Prod.php/_manager/assets/publish/_all/all ">Publish all</a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="btn-default btn publishalldevassets"  attr-href="/Prod.php/_manager/assets/publish/_all/dev">Publish all dev</a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="btn-default btn publishallprodassets"  attr-href="/Prod.php/_manager/assets/publish/_all/prod">Publish all prod</a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="btn-default btn clearallassets"  attr-href="/Prod.php/_manager/assets/clear/_all/all">Clear all</a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="btn-default btn clearalldevassets"  attr-href="/Prod.php/_manager/assets/clear/_all/dev">Clear all dev</a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="btn-default btn clearallprodassets"  attr-href="/Prod.php/_manager/assets/clear/_all/prod">Clear all prod</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody class="getAllAssets" attr-href="/Prod.php/_manager/assets/get/all">
