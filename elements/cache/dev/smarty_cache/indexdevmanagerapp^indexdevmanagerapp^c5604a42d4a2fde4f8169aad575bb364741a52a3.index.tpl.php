<?php
/* Smarty version 3.1.31, created on 2017-11-03 16:28:53
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59fc8b35228315_63932045',
...
function content_59fc8b35228315_63932045 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
<head>
                    ...
                    <div class="row">
                            ...
                            <div class="h350 card">
                                ...
                                <div class="content"  style="overflow: auto;padding-left: 40px;max-height: 220px;">
                                    <ul class="break-word col-md-12">
                                        <li>iumio Framework Standard Edition </li>

                                        <li>Version : BETA 0.5.0 </li>

                                        <li>Build number : 201750 </li>

                                        <li>Installation date : 2017/10/24</li>

                                        <li>User installed : danyrafina</li>

                                        <li>Main location installed : /Applications/MAMP/htdocs/iumio-framework</li>

                                        <li>Main OS installed : Darwin</li>
                        ...
                        <div class="col-md-6">
                            <div class="card h350">
                                <div class="header">
                                    ...
                                    <p class="category">Last logs errors for dev (10)</p>
                                </div>
                                <div class="content" style="overflow: auto;max-height: 220px">
                                    <ul class="lastlog elemcard" attr-href="/_manager/get/logs">
                        ...
                        <div class="col-md-6">
                            <div class="card h350">
                                ...
                                <div class="content dashboardStats elemcard"  attr-href="/_manager/get/framework/statistics" style="overflow: auto;padding-left: 40px">
                                    <ul class="col-md-6">
