...
class __iumioTemp_171978ca88e40d41bdfa5b5eb2e182c4 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <a href="#" class="logo">iumio Starter</a>
';
...
';
        $buffer .= $indent . '<section id="banner" style="background-image: url(\'';
        // 'webassets' section
        $value = $context->find('webassets');
        $buffer .= $this->section31a2e22b984530aadbb7d922563a0c17($context, $indent, $value);
        $buffer .= '\');">
';
        $buffer .= $indent . '    <h1>Welcome to iumio Starter</h1>
';
        $buffer .= $indent . '    <p>Your parameter is ';
...
';
    ...
    private function section31a2e22b984530aadbb7d922563a0c17(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    
        if (is_object($value) && is_callable($value)) {
            $source = 'public/images/banner.jpg';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'public/images/banner.jpg';
                $context->pop();
            }
        }
