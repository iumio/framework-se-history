                ...
                for(var i = 0; i < ObjectLength(result); i++)
                {
                    ...
                    if (start == 0)
                     var e =   '<li class="iumioTaskBarOneLog" > ' +
                             '<table class="iumioTaskbarTable"><thead><tr><th>UIDIE</th> <th>Method</th> <th>Code</th> <th>URL</th> </tr></thead> <tbody> <tr> <td class="iumiouidieurl" onclick="location.href=\''+result[i]['log_url']+'\'">'+result[i]['uidie'] +'</td> <td>'+((result[i]['method'])) +'</td> <td>'+((result[i]['code'])) +'</td> <td>'+(result[i]['referer']).substr(0, 19) +' '+(((result[i]['referer']).length > 19)? '...' : '' )+'</td> </tr> </tbody> </table>'+
                         '</li>';
                    else
                        var e =   '<li class="iumioTaskBarOneLog" > ' +
                            '<table class="iumioTaskbarTable"><thead></thead><tbody> <tr> <td class="iumiouidieurl" onclick="location.href=\''+result[i]['log_url']+'\'">'+result[i]['uidie'] +'</td> <td>'+((result[i]['method'])) +'</td> <td>'+((result[i]['code'])) +'</td> <td>'+(result[i]['referer']).substr(0, 19) +' '+(((result[i]['referer']).length > 19)? '...' : '' )+'</td> </tr> </tbody> </table>'+
                            '</li>';
                    str += e;
                    u++;
