            ...
            if (data['code'] === 200)
            {
                ...
                $.each(results, function (index, value) {
                    selector.append("<tr>" +
                        ...
                        "<td>"+value['path']+"</td>" +
                        "<td>"+value['size']+"</td>" +
                        "<td "+((value['perms'] === true)? 'style="background-color:#2ECC40;color:white;text-align:center"' : 'style="background-color:rgba(193, 9, 9, 0.5);color:white;text-align:center"')+">"+value['nperms']+"</td>" +
                        "<td>"+value['status']+"</td>" +
            ...
            if (data['code'] === 200)
            {
                ...
                $.each(results, function (index, value) {
                    ...
                    selector.append("<tr>" +
                        ...
                        "<td "+((value['status_dev'] === 1)? 'style="background-color:#2ECC40;color:white;"' : 'style="background-color:rgba(193, 9, 9, 0.5);color:white;text-align:center"')+">"+((value['status_dev'] === 1)? 'OK' : 'Need to publish')+"</td>" +
                        "<td "+((value['status_prod'] === 1)? 'style="background-color:#2ECC40;color:white;"' : 'style="background-color:rgba(193, 9, 9, 0.5);color:white;text-align:center"')+">"+((value['status_prod'] === 1)? 'OK' : 'Need to publish')+"</td>" +
    ...
    $.ajax({
        ...
        success : function(data){
            if (data['code'] === 200)
            {
                ...
                $('.dashb-reqsuc').html(rs['logs']['success']);
                $('.dashb-err').html(rs['logs']['errors']);
                $('.dashb-errcri').html(rs['logs']['critical']);
                $('.dashb-erroth').html(rs['logs']['others']);
            }
        },
        error : function (data) {
            operationError(data);
