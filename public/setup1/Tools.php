...
class Tools
{
    ...
    {
        $base = __DIR__."/../../";
        include_once $base . "vendor/iumio_framework/Core/ServerManager/ServerManager.php";
        $temdirbase = $base."vendor/iumio_framework/Core/Additional/Manager/Module/AppManager/AppTemplate";
