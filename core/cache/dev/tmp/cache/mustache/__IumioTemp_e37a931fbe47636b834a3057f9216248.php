...
class __IumioTemp_e37a931fbe47636b834a3057f9216248 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section131370e8a9145a5eb743ad360a9239ea($context, $indent, $value);
        $buffer .= '
';
...
';
    ...
    private function section131370e8a9145a5eb743ad360a9239ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
