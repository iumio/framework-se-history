...
class __IumioTemp_c084320a8c359899d8ccd9f82ebdeeae extends Mustache_Template
{
...
';
        // 'js_fgm' section
        $value = $context->find('js_fgm');
        $buffer .= $this->section28db499921740430f34c522c1e101b40($context, $indent, $value);
        $buffer .= '
';
...
';
    ...
    private function section28db499921740430f34c522c1e101b40(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
