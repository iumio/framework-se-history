...
class __IumioTemp_603850d13d076e8f1483828f8f17b79d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF982ef4701d0959abb89f91c214fc84e($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF982ef4701d0959abb89f91c214fc84e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    
        if (is_object($value) && is_callable($value)) {
            $source = 'fgm_libs/css/animate.min.css';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'fgm_libs/css/animate.min.css';
                $context->pop();
            }
        }
