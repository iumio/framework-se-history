...
class __IumioTemp_0fbf568ff4dd06e604bf3f9906fd88e9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    ';
        // 'css_component' section
        $value = $context->find('css_component');
        $buffer .= $this->section4dc21d0d1ffc75d7ebff7e26d4a78779($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section4dc21d0d1ffc75d7ebff7e26d4a78779(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    
        if (is_object($value) && is_callable($value)) {
            $source = 'fgm_libs/assets/css/animate.min.css';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'fgm_libs/assets/css/animate.min.css';
                $context->pop();
            }
        }
