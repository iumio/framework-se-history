...
class __IumioTemp_94098245b8d237c9080390affc772b12 extends Mustache_Template
{
...
';
        ...
        $filter = $context->find('bootstrap(min)');
        if (!(is_object($filter) && is_callable($filter))) {
            throw new Mustache_Exception_UnknownFilterException('bootstrap(min)');
        }
