...
class Uninstaller
{
    ...
    final public static function removeComponents()
    {
        ...
        @iSM::delete(self::$base_dir."public/components/rt/config_files/map.irt.js", "file");

        @iSM::delete(self::$base_dir."public/components/rt/config_files/map.irt.base.js", "file");
    }
}
