...
class AutoloaderManager extends ToolsManager implements ModuleManager
{
    ...
    private function deleteClassMap()
    {
        ...
        Server::delete(FEnvFcm::get("framework.config")."engine_autoloader/map_class.json", 'file');
        @Server::create(FEnvFcm::get("framework.config")."engine_autoloader/map_class.json", 'file');
