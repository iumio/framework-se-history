...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="180x180" href="{img_manager path='favicon/apple-touch-icon.png'}">
    <link rel="icon" type="image/png" sizes="32x32" href="{img_manager path='favicon/favicon-32x32.png'}">
    <link rel="icon" type="image/png" sizes="16x16" href="{img_manager path='favicon/favicon-16x16.png'}">
