...
class Installer
{
    ...
    final public static function downloadComponents()
    {
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/js/bootstrap-notify.js"
        );
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/js/bootstrap-select.js"
        );
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/fonts/Pe-icon-7-stroke.eot"
        );
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/fonts/Pe-icon-7-stroke.svg"
        );
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/fonts/Pe-icon-7-stroke.ttf"
        );
        ...
        iSM::move(
            ...
            self::$base_dir."web/components/libs/iumio_manager/fonts/Pe-icon-7-stroke.woff"
        );
    }
