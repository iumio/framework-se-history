...
class Smarty_Internal_Debug extends Smarty_Internal_Data
{
    ...
    public function display_debug($obj, $full = false)
    {
        ...
        // ADD iumioTaskBar
        $taskbar = \iumioFramework\Core\Additionnal\TaskBar\iumioTaskBar::getTaskBarOptions();
        ...
        {
            if (DISPLAY_SMARTY_DEBUG == "on")
                $_template->assign('debug_smarty_display', 'on');
            else if (DISPLAY_SMARTY_DEBUG == "off")
                $_template->assign('debug_smarty_display', 'off');
            else
                $_template->assign('debug_smarty_display', 'off');
        }
        // END display debug smarty check
